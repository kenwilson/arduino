...
void loop() {
  ...
  if (millis() - lastMillis > (update_interval * 1000)) {
    ...
    lastMillis = millis();
    update_reading();
    client.publish("/home/weather/" + mqtt_id + "/temp", String(temp) + " C");
    client.publish("/home/weather/" + mqtt_id + "/humidity", String(humidity) + " %");
    client.publish("/home/weather/" + mqtt_id + "/pressure", String(pressure) + " hPA");
    client.publish("/home/weather/" + mqtt_id + "/culm_rainfall", String(rainfall) + " mm");
